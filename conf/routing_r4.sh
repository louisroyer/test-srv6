...
ip -6 route add fd00:51D5:0000:4:11::/80 encap seg6local action End.DX4 nh4 0.0.0.0 dev sid table localsid proto static
ip -6 route add fd00:51D5:0000:4:1::/80 encap seg6local action End dev sid table localsid proto static
