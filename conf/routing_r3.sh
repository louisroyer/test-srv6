...
# Add sid
ip sr tunsrc set fd00:51D5:0000:3::
ip link add sid type dummy
ip link set dev sid up
echo 100 localsid >> /etc/iproute2/rt_tables
ip -6 rule add to fd00:51D5:0000:3::/64 lookup localsid
ip -6 route add blackhole default table localsid
ip -6 route add fd00:51D5:0000:3:1::/80 encap seg6local action End dev sid table localsid proto static
